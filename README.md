...
Проект моделирует рабочее место с роботом **KUKA LBR iiwa 7 R800**, двупальцевым захватом и RGB/Depth‑камерой. Репозиторий включает:
...
## Возможности
- Управление **iiwa7** в базовом мире и в мире **калибровки Eye‑in‑hand**.
- Движение по **декартовым командам** (IK + планировщик траектории) и по **CSV‑траектории** в суставах.
